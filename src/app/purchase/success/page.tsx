            ...
            <div className="bg-gray-800 rounded-2xl p-8 mb-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between py-3 border-b border-gray-700">
                  ...
                  <span className="font-semibold">{orderInfo.product}</span>
                </div>
                <div className="flex justify-between py-3 border-b border-gray-700">
                  <span className="text-gray-300">{t('success.order.price')}</span>
                  <span className="font-semibold text-blue-400">{orderInfo.price}</span>
                </div>
                <div className="flex justify-between py-3 border-b border-gray-700">
                  <span className="text-gray-300">{t('success.order.payment')}</span>
                  <span className="font-semibold">{orderInfo.payment}</span>
                </div>
                <div className="flex justify-between py-3 border-b border-gray-700">
                  <span className="text-gray-300">{t('success.order.name')}</span>
                  <span className="font-semibold">{orderInfo.name}</span>
                </div>
                <div className="flex justify-between py-3 border-b border-gray-700">
                  <span className="text-gray-300">{t('success.order.phone')}</span>
                  <span className="font-semibold">{orderInfo.phone}</span>
                </div>
              </div>
            </div>
          </FadeInUp>
